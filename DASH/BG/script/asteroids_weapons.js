...
(function()
{
   ...
   extend(Asteroids.VSprayCannonsWeapon, Asteroids.Weapon,
   {
      doFire: function()
      {
         ...
         t = new Vector(0.0, -9.75).rotate(h * RAD).add(this.player.vector);
...
(function()
{
   ...
   extend(Asteroids.SideGunWeapon, Asteroids.Weapon,
   {
      doFire: function()
      {
         ...
         t = new Vector(0.0, -9.5).rotate(h * RAD).add(this.player.vector);
